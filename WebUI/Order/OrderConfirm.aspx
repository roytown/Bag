     ...
     <div class="right">
        	<table cellpadding="0" cellspacing="0" border="0" width="98%" class="table2">
                <tr>
                    ...
                    <td>
                        <bag:TextBoxEx ID="tbPublishUserName" Width="100" runat="Server" CssClass="input" IsRequired="true"  RequiredErrorMessage="请输入生产负责人"  />
                     </td>
            	</tr>
                <tr>
            		<td class="td2_1">质检负责人：</td>
                    <td>
                        <bag:TextBoxEx ID="tbQualityUserName" Width="100" runat="Server" CssClass="input" IsRequired="true"  RequiredErrorMessage="请输入质检负责人"   />
                     </td>
            	</tr>
                <tr>
